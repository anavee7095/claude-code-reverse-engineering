...
6. Open the extracted folder to read the design docs.
...
## 🛠️ Common ways to view the docs
...
- `.md` for design docs
- `.ts` for TypeScript examples
- `.json` for config data
- `.tf` for Terraform files
- `.yaml` or `.yml` for setup files
...
## ⚙️ If you want to inspect it in VS Code

1. Install Visual Studio Code.
2. Open VS Code.
3. Click File > Open Folder.
4. Select the extracted repo folder.
5. Use the Explorer panel to browse the docs.
...
3. Extract the ZIP.
4. Open the folder.
5. Read the Markdown files.
6. Use VS Code if you want a cleaner view.
